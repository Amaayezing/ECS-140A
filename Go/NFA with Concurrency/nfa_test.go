...
func TestReachable(t *testing.T) {
	...
	tests := []struct {
		...
		{"dagTransitions", 1, 2, []rune{'b'}, false},
		{"dagTransitions", 1, 0, []rune{'c'}, false},
		{"dagTransitions", 1, 3, []rune{'b'}, true},
		{"dagTransitions", 3, 0, []rune{'c', 'b', 'a'}, false},
		{"dagTransitions", 3, 1, []rune{'c', 'b', 'a'}, false},
		{"dagTransitions", 3, 2, []rune{'b', 'a'}, false},
		...
		{"expTransitions", 0, 1, []rune{'a', 'b', 'a', 'b'}, false},
		{"expTransitions", 1, 0, []rune{'b'}, true},
		{"expTransitions", 2, 0, []rune{'b'}, false},
		{"expTransitions", 2, 1, []rune{'a', 'b'}, false},
		{"expTransitions", 1, 2, []rune{'a', 'b'}, false},
		...
		{"langTransitions", 0, 1, []rune{'a', 'b'}, true},
		{"langTransitions", 1, 0, []rune{'a', 'b'}, true},
		{"langTransitions", 1, 1, []rune{'a', 'b'}, false},
		{"langTransitions", 1, 0, []rune{'a'}, false},
		{"langTransitions", 1, 1, []rune{'a'}, true},
		...
		//{"loopTransitions", 0, 1, []rune{'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a', 'a'}, true},
